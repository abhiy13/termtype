...
const QUOTES_URL = "https://raw.githubusercontent.com/monkeytypegame/monkeytype/master/frontend/static/quotes/english.json"
...
export async function fetchMonkeyTypeQuotes(): Promise<{ quotes: MonkeyTypeQuote[], fromNetwork: boolean }> {
...
export async function getRandomMonkeyTypeQuote(
    ...
    const filteredQuotes = quotes.filter(
        q => q.length >= minLength && q.length <= maxLength
    )
